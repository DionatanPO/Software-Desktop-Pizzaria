...
public class LoginVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/pizza-icon.png"))); // NOI18N
        ...
        email.setForeground(new java.awt.Color(99, 15, 229));
        email.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(99, 15, 229)));
        ...
        senha.setForeground(new java.awt.Color(99, 15, 229));
        senha.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(99, 15, 229)));
        ...
        jButton3.setForeground(new java.awt.Color(99, 15, 229));
        jButton3.setText("É novo aqui? Criar conta");
        ...
        kButton1.setkHoverColor(new java.awt.Color(102, 102, 255));
        kButton1.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        kButton1.setkHoverStartColor(new java.awt.Color(153, 153, 255));
        kButton1.setkIndicatorColor(new java.awt.Color(0, 204, 153));
        kButton1.setkSelectedColor(new java.awt.Color(0, 204, 153));
        ...
        jLabel9.setText("Entre para fazer seu pedido");
        ...
        jButton4.setText("Entrar como administrador");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(aviso2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(senha, javax.swing.GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(aviso1, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(senha, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(aviso2, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(19, 19, 19)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton3)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        new Cadastro_ClientesVIEW().setVisible(true);//que quer abrir
        dispose();
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        if (email.getText().trim().isEmpty()) {
            ...
            aviso1.setText("O Campo 'email' esta em branco");
           // JOptionPane.showMessageDialog(null, "O Campo 'email' esta em branco");

        } else if (senha.getText().trim().isEmpty()) {
            //instrucao para campo vazio
            aviso2.setText("O Campo 'senha' esta em branco");
            //JOptionPane.showMessageDialog(null, "O Campo 'senha' esta em branco");

        } else {
            String s = String.valueOf(senha.getPassword());
            ArrayList<String> myArrayList = new ArrayList<>();
            myArrayList.add(email.getText());
            myArrayList.add(s);
            LoginControl lc = new LoginControl();
            lc.receber_lista_altentificacao(myArrayList);
        }
